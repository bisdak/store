...
def test_prefers_earlier_batches():
    earliest = Batch("speedy-batch", "BLACK-BAG", 100, eta=today)
    medium = Batch("normal-batch", "BLACK-BAG", 100, eta=tomorrow)
    latest = Batch("slow-batch", "BLACK-BAG", 100, eta=later)
    product = Product(sku='BLACK-BAG', batches=[medium, latest, earliest])
    line = OrderLine("order1", "BLACK-BAG", 10)
